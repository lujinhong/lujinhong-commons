package com.lujinhong.commons.storm.kafka.trident;
...
import com.lujinhong.commons.storm.kafka.trident.functions.WordSplit;
import com.lujinhong.commons.storm.kafka.trident.state.HazelCastStateFactory;
...
public class SentenceAggregationTopology {
    ...
    public StormTopology buildTopology(LocalDRPC drpc) {
        ...
        TridentKafkaConfig kafkaConfig = new TridentKafkaConfig(brokerHosts, "monitor2.network", "storm");
...
//                .aggregate(new Fields("count"), new Sum(), new Fields("sum"));
     ...
     * args[1]:topo名称
     * args[2]:nimbus节点，如,192.168.172.98
     */
    public static void main(String[] args) throws Exception {
        ...
        if (args != null && args.length > 1) {
            ...
            while (true) {
                System.out.println("Word count: " + drpc.execute("words", "the login Login"));
                Utils.sleep(1000);
            }
