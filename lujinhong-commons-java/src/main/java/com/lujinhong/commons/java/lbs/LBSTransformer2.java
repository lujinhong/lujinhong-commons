...
/**
 * AUTHOR: LUJINHONG
 * CREATED ON: 17/2/21 22:10
 * PROJECT NAME: aplus_dmp
 * DESCRIPTION: 百度坐标系、火星坐标系、地球坐标系之间互相转换。
 */
public class LBSTransformer2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        double lat = 23.117500452966457;
        double lng = 113.4247365;
        LatLng ll = null;

        //假设是世界坐标系
        ll = wgs84ToBd09(new LatLng(lat, lng));
        System.out.println(ll.getLatitude() + "\t" + ll.getLongitude());


        ll = wgs84ToGcj02(new LatLng(lat, lng));
        System.out.println(ll.getLatitude() + "\t" + ll.getLongitude());

        //假设是火星坐标系
        ll = gcj02ToWgs84(new LatLng(lat, lng));
        System.out.println(ll.getLatitude() + "\t" + ll.getLongitude());


        ll = gcj02ToBd09(new LatLng(lat, lng));
        System.out.println(ll.getLatitude() + "\t" + ll.getLongitude());

        //假设是百度
        ll = bd09ToWgs84(new LatLng(lat, lng));
        System.out.println(ll.getLatitude() + "\t" + ll.getLongitude());


        ll = bd09ToGcj02(new LatLng(lat, lng));
        System.out.println(ll.getLatitude() + "\t" + ll.getLongitude());
